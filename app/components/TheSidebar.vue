<template>
    <aside class="flex flex-col justify-between p-5 bg-primary-100 h-screen transition-all duration-300"
        :class="{ 'max-w-[200px]': !isSideBarHidden, 'max-w-[80px]': isSideBarHidden }">
        <div class="flex flex-col gap-5">
            <div class="flex flex-row items-center gap-5">
                <img class="h-10 w-10 rounded-full" src="../assets/images/logo.png" alt="logo">
                <p class="font-md" :class="{ 'hidden': isSideBarHidden }">FinSet</p>
            </div>
