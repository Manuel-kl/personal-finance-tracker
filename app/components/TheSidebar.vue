<template>
    <aside
        class="fixed flex flex-col justify-between p-5 bg-primary-100 h-screen transition-all duration-300"
        :class="{
    ...
    >
        <div class="flex flex-col gap-5">
            ...
            <div class="flex flex-col gap-1 justify-center">
                ...
                >
                    ...
                    <span class="text-sm" :class="{ hidden: isSideBarHidden }"
                        >Dashboard</span
                    >
                </NuxtLink>
                <NuxtLink
                ...
                >
                    <UIcon
                        name="mingcute:receive-money-line"
                        width="24"
                        height="24"
                    />
                    <span class="text-sm" :class="{ hidden: isSideBarHidden }"
        ...
        <div class="flex flex-col gap-10">
            <div class="flex flex-col gap-1">
                ...
                <div
                    class="flex items-center gap-2 py-2 px-3 hover:bg-primary-700 hover:text-white rounded-full transition-colors duration-300 cursor-pointer"
